...
const EXPERIENCES: TimelineItem[] = [
  {
    ...
    subtitle: "Bachelor's Degree (S1 Teknik Informatika)",
    company: "Informatics Engineering",
    period: "Graduated",
    location: "Indonesia",
    description:
      "Graduated with a Bachelor's Degree in Informatics Engineering (S1 Teknik Informatika). Specialized in Software Architecture, Data Structures, Web Systems Architecture, and Relational Database Systems.",
    isCurrent: false,
